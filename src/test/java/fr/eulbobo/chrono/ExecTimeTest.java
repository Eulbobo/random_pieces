...
public class ExecTimeTest {
    ...
    public void should_get_correct_message_when_0_millis_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 0 Minutes| 0 Secondes| 0 Milisecondes");
    }
    ...
    public void should_get_correct_message_when_2_hours_35_minuts_25second_and_525_millis_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("2 Heures| 35 Minutes| 25 Secondes| 525 Milisecondes");
    ...
    public void should_get_correct_message_when_5_minuts_and_45second_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 5 Minutes| 45 Secondes| 0 Milisecondes");
    }
    ...
    public void should_get_correct_message_when_3_minuts_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 3 Minutes| 0 Secondes| 0 Milisecondes");
    }
    ...
    public void should_get_correct_message_when_1000_millis_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 0 Minutes| 1 Secondes| 0 Milisecondes");
    }
    ...
    public void should_get_correct_message_when_100_millis_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 0 Minutes| 0 Secondes| 100 Milisecondes");
    }
    ...
    public void should_get_correct_message_when_1_millis_have_passed() {
        ...
        assertThat(message)
                .isNotNull()
                .isEqualTo("0 Heures| 0 Minutes| 0 Secondes| 1 Milisecondes");
    }
}
